...
namespace vr
{
	VrPipeline::VrPipeline(
		...
		const PipelineConfigInfo& configInfo) : vrDevice{device}
	{
	...
	void VrPipeline::DefaultPipelineConfigInfo( PipelineConfigInfo& configInfo, uint32_t width, uint32_t height)
	{
		...
		const PipelineConfigInfo& configInfo)
	{
		...
		if (vkCreateGraphicsPipelines(vrDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
		{
